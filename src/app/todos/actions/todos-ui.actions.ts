...
export const loadTodosFail = createAction('[TodoModule] LoadTodosFail', props<{ error: string }>());

export const addTodoRequest = createAction('[TodoModule] AddTodoRequest', props<{ todo: Todo }>());

export const addTodoSuccess = createAction('[TodoModule] AddTodoSuccess');

export const addTodoFail = createAction('[TodoModule] AddTodoFail', props<{ error: string }>());
...
export const updateTodoSuccess = createAction('[TodoModule] updateTodoSuccess');
...
export const deleteTodoSuccess = createAction('[TodoModule] DeleteTodoSuccess');
