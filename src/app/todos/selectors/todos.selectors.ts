...
export const geTodosState = createSelector(getTodosModuleState, (state) => state.todos);
...
export const getVisibleTodos = createSelector(getAllTodos, getRouterState, (todos, router) => {
...
export const getTodo = createSelector(getEntitiesTodos, getRouterState, (entities, router) => {
    if (router?.state?.params) {
...
export const getCountVisibleTodos = createSelector(getVisibleTodos, (todos) => todos.length);
